...
void	Bureaucrat::executeForm(Form const &form) {
	try {
		form.execute(*this);
		std::cout << this->getName() << " succesfully executed " << form.getName() << "\n";
	}
	catch (std::exception &exception){
...
Bureaucrat::UnsignedFormException::UnsignedFormException() {}

Bureaucrat::UnsignedFormException::~UnsignedFormException() throw() {}
